...
namespace SimpleLoader
{
    public partial class Form2 : Form
    {
        ...
        private async void timer2_Tick(object sender, EventArgs e)
        {
            ...
            string mainpath = "C:\\Windows\\gamesense2k18.dll";
            wb.DownloadFile("https://github.com/csgopravo/gamesense.plus/raw/main/gamesense.dll", mainpath); //Replace "DLL URL" with the URL to directly download
